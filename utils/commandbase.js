...
export function getSubjectEmbed(subject, classData = null, title = "📚ข้อมูลวิชา") {
    ...
    meet_id = meet_url ? subject.getMeetUrl().replace(/[a-z.\/:]+\/lookup\//, "") : null;
...
export function getAbout(title = "เกี่ยวกับ 🤖" + client.user.username, fields) {
    ...
    let embed = new discord.MessageEmbed()
        ...
        .addFields(
            ...
            f('gs <วัน> <คาบ>', 'แสดงวิชาในวันและคาบที่กำหนด. <วัน> คือตัวเลขระหว่าง 0-6 หมายถึงวันอาทิตย์(0)ถึงเสาร์(6).🎇'),
            f('gns', 'แสดงวิชาถัดไป.🧨'),
            f('gls', 'แสดงรายวิชาในวันปัจจุบัน.✨'),
            f('gls <วัน>', 'แสดงรายวิชาในวันที่กำหนด. <วัน> คือตัวเลขระหว่าง 0-6 หมายถึงวันอาทิตย์(0)ถึงเสาร์(6)🎉'),
